...
@Component
@CommandLine.Command(name = "revoke_one", mixinStandardHelpOptions = true,
...
public class Revoke implements Callable<Integer> {
    ...
    @CommandLine.Option(names = {"--airdrop_id"}, description = "function address", required = true)
    String airdropId;
    @CommandLine.Option(names = {"--root_hash"}, description = "root hash", required = true)
    String rootHash;
    ...
    public Integer call() {
        ...
        chainService.call_function(functionAddress + "::MerkleDistributorScript::revoke_airdrop",
                ...
                Lists.newArrayList(airdropId, rootHash));
        return null;
    }
}
